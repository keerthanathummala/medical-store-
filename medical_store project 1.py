print(" project topic :- MEDICAL STORE MANAGEMENT ")
...
priception=""
p=["Hypertension","Diabetes1","Diabetes2"]
    ...
    for j in range(len(p)):
        if symptoms[i]==p[j]:
            ...
            while (priception ==""): #keep asking user till they enter the priception
                priception=input("enter your doctors priception : ")
...
medication={"Cold": "paracetamol 500mg  every 4 to 6 hours as necessary for relief",
            ...
            "Acidity":"Antacids Calcium carbonate: 500 mg to 1000 mg as symptoms occur, up to 3000 mg per day.",
            ...
            "Skin infection":"Clindamycin Apply a thin layer of the topical gel or cream to the affected area(s) twice daily.The affected area should be clean and dry before applying the medication.Wash hands after application unless the hands are the area being treated",
...
Hypertension= {"Enalapril": "5-40 mg once daily",
        "Lisinopril": "10-40 mg once daily",
        "Ramipril":"2.5-20 mg once daily",
        "Losartan":" 25-100 mg once daily","Valsartan": "40-320 mg once daily",
        "Telmisartan": "20-80 mg once daily",
        "Amlodipine": "2.5-10 mg once daily","Nifedipine ER": "30-90 mg once daily",
        "Diltiazem_ER": "120-360 mg once daily","Hydrochlorothiazide (HCTZ)": "12.5-50 mg once daily",
        "Chlorthalidone": "12.5-25 mg once daily","Indapamide": "1.25-2.5 mg once daily",
        "Atenolol": "25-100 mg once daily","Metoprolol": "25-100 mg twice daily",
        "Bisoprolol": "2.5-10 mg once daily","Doxazosin": "1-16 mg once daily",
        "Aliskiren": "150-300 mg once daily","Clonidine": "0.1-0.3 mg twice daily",
        "Methyldopa": "250-1000 mg two to three times daily",}
Diabetes1={"Insulin lispro": "Administered before meals to control postprandial glucose spikes",
...
Diabetes2={"Metformin":" 500 mg or 850 mg once daily with meals","Glipizide": "5 mg once daily, with adjustments up to 20 mg per day.",
            "Glyburide": "2.5 mg to 5 mg once daily, with adjustments up to 20 mg per day.","Glimepiride": "1-2 mg once daily, with adjustments up to 8 mg per day.",
            "Sitagliptin": "The usual dose is 100 mg once daily.","Saxagliptin": "The usual dose is 2.5 mg to 5 mg once daily.",
            "Linagliptin": "The usual dose is 5 mg once daily.",           
    }
if 1<=age<=5 or BMI<18: #based on the age and BMI medication changes
    medication2={"Fever":"Acetaminophen dosage is 160 to 240 mg every 4 to 6 hours as needed. The maximum daily dosage should not exceed 960 mg",
             ...
             "Headache":"Acetaminophen dosage is 240 mg to 320 mg every 4 to 6 hours as needed, not exceeding 5 doses in 24 hours.",
             ...
             "Sorethrought":" Acetaminophen 10 to 15 milligrams (mg) per kilogram (kg) of body weight, every 4 to 6 hours, as needed ",
...
if 6<=age<=11 or BMI<18 :
    medication2={"Fever":"Acetaminophen dosage is 320 to 480 mg every 4 to 6 hours as needed. The maximum daily dosage should not exceed 2,400 mg",
...
h=[Hypertension,Diabetes1,Diabetes2] #inputiing all the symptoms which require preception into a list
